...
const Footer = () => {
    return (
        <div>
             <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-full md:px-24 lg:px-8 bg-[#007D7C] mt-8 text-white ">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-2 text-sm">
          <p className="text-base font-bold tracking-widetext-white">
            Contacts
          </p>
          <div className="flex">
